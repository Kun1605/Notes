...
Terminal=false
Name=IntelliJ IDEA
Icon=/search/codeide/idea-IU/bin/idea.png
Exec=env JAVA_HOME=/search/codeide/jdk1.8.0_161 /search/codeide/idea-IU/bin/idea.sh
StartupWMClass=idea
Terminal=false
Type=Application
...
```
*.iml;*.idea;*.gitignore;*.classpath;*.project;*.settings;target;
```