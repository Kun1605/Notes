...
<form:form commandName="queryFilter" id="adminForm" name="adminForm" action="${selectURL}">
    <fieldset class="filter">
        <div id="filter-bar" class="btn-toolbar">
            ...
            <div class="btn-group pull-left">
                ...
                <button type="button" class="btn button-select" data-user-value="0" data-user-name="选择一个业务组成员"
                        data-user-field="jform_userId">- 没有业务组成员 -</button>
            </div>
        </div>
    </fieldset>
    ...
    <div>
        ...
        <form:hidden path="filter[groupId]" />
</form:form>
<!-- End Status Module -->
