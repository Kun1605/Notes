...
<s:url value="/manage/privilege/user/saveBusinessPrivilege" var="saveURL"/>
<!DOCTYPE html>
...
<c:set var="isEdit" value="${manageUser.id != null}"/>
            ...
            <div class="span12">
                ...
                <div class="row-fluid">
                    ...
                    <form id="authorize-form" method="post" name="authorizeForm"
                          action="${saveURL}">
                        <div class="span12">
                            <legend>为用户 ${manageUser.name} 授权可用业务</legend>
