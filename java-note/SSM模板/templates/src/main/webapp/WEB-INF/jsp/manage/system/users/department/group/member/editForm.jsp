...
<s:url value="/manage/system/users/department/group/member/save" var="saveURL"/>
<form:form modelAttribute="groupUser" id="edit-form" method="post" name="adminForm"
        ...
        <div class="control-group">
            <div class="control-label">
                <label id="jform_userPosition-lbl" for="jform_userPosition" class="hasTooltip required"
                       title="<sg:message code="TIP_TITLE" ref="groupUser.userPosition,groupUser.userPosition.tip"/>">
                    <s:message code="groupUser.userPosition"/><span class="star">&#160;*</span></label>
            </div>
            <div class="controls">
                <s:message code="groupUser.userPosition" var="userPosition_option"/>
