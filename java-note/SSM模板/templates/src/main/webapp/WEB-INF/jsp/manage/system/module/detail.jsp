...
<s:url value="/manage/system/module/delete?id=${showModuleInfo.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.parentId"/></strong></td>
                                        <td>
                                            ${showModuleInfo.parentId}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.code"/></strong></td>
                                        <td>
                                            ${showModuleInfo.code}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.value"/></strong></td>
                                        <td>
                                            ${showModuleInfo.value}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.orderNumber"/></strong></td>
                                        <td>
                                            ${showModuleInfo.orderNumber}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.pkgName"/></strong></td>
                                        <td>
                                            ${showModuleInfo.pkgName}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.path"/></strong></td>
                                        <td>
                                            ${showModuleInfo.path}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.enable"/></strong></td>
                                        <td>
                                            ${showModuleInfo.enable}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.inletUri"/></strong></td>
                                        <td>
                                            ${showModuleInfo.inletUri}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="moduleInfo.discard"/></strong></td>
                                        <td>
                                            ${showModuleInfo.discard}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="moduleInfo.id"/></strong></td>
                                    <td>
                                        ${showModuleInfo.id}
                                    </td>
                                </tr>
