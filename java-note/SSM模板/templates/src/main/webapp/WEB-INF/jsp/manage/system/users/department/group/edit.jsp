...
<s:url value="/manage/system/users/department/group/list?departmentId=${groupInfo.departmentId}" var="listURL"/>
<s:url value="${backURL}&departmentId=${groupInfo.departmentId}" var="jsBackURL"/>
<!DOCTYPE html>
