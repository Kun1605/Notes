...
<s:url value="/manage/system/log/noticelog/edit" var="addURL"/>
<s:url value="/manage/system/log/noticelog/edit?id=${systemNoticeLog.id}" var="editURL"/>
<s:url value="/manage/system/log/noticelog/delete?id=${systemNoticeLog.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="systemNoticeLog.userId"/></strong></td>
                                        <td>
                                            ${systemNoticeLog.username}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemNoticeLog.noticeType"/></strong></td>
                                        <td>
                                            ${systemNoticeLog.getNoticeTypeDescription()}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemNoticeLog.sendMode"/></strong></td>
                                        <td>
                                            ${systemNoticeLog.getSendModeDescription()}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemNoticeLog.sendContent"/></strong></td>
                                        <td>
                                            ${systemNoticeLog.sendContent}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemNoticeLog.noticeTime"/></strong></td>
                                        <td>
                                            ${systemNoticeLog.getNoticeTimeFormat()}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="systemNoticeLog.id"/></strong></td>
                                    <td>
                                        ${systemNoticeLog.id}
                                    </td>
                                </tr>
