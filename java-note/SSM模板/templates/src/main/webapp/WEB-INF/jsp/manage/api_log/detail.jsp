...
<s:url value="/manage/api_log/edit" var="addURL"/>
<s:url value="/manage/api_log/edit?id=${apiLog.id}" var="editURL"/>
<s:url value="/manage/api_log/delete?id=${apiLog.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="apiLog.businessUid"/></strong></td>
                                        <td>
                                            ${apiLog.businessUid}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="apiLog.path"/></strong></td>
                                        <td>
                                            ${apiLog.path}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="apiLog.actionTime"/></strong></td>
                                        <td>
                                            ${apiLog.fullFormatActionTime}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="apiLog.resCode"/></strong></td>
                                        <td>
                                            ${apiLog.resCodeDescription}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="apiLog.id"/></strong></td>
                                    <td>
                                        ${apiLog.id}
                                    </td>
                                </tr>
