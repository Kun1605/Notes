...
<s:url value="/manage/system/log/error/edit" var="addURL"/>
<s:url value="/manage/system/log/error/edit?id=${systemMessage.id}" var="editURL"/>
<s:url value="/manage/system/log/error/delete?id=${systemMessage.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="systemMessage.title"/></strong></td>
                                        <td>
                                            ${systemMessage.title}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemMessage.messageLevel"/></strong></td>
                                        <td>
                                            ${systemMessage.messageLevelDescription}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemMessage.messageModule"/></strong></td>
                                        <td>
                                            ${systemMessage.messageModule}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemMessage.messageLine"/></strong></td>
                                        <td>
                                            ${systemMessage.messageLine}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemMessage.message"/></strong></td>
                                        <td>
                                            <pre><code>${systemMessage.escapeMessage}</code></pre>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="systemMessage.messageTime"/></strong></td>
                                        <td>
                                            ${systemMessage.messageTimeStr}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="systemMessage.id"/></strong></td>
                                    <td>
                                        ${systemMessage.id}
                                    </td>
                                </tr>
