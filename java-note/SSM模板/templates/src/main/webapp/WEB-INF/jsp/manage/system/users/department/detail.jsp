...
<s:url value="/manage/system/users/department/edit" var="addURL"/>
<s:url value="/manage/system/users/department/edit?id=${departmentInfo.id}" var="editURL"/>
<s:url value="/manage/system/users/department/delete?id=${departmentInfo.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="departmentInfo.departmentName"/></strong></td>
                                        <td>
                                            ${departmentInfo.departmentName}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="departmentInfo.departmentMemo"/></strong></td>
                                        <td>
                                            ${departmentInfo.departmentMemo}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="departmentInfo.status"/></strong></td>
                                        <td>
                                            ${departmentInfo.status}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="departmentInfo.createTime"/></strong></td>
                                        <td>
                                            ${departmentInfo.createTime}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="departmentInfo.id"/></strong></td>
                                    <td>
                                        ${departmentInfo.id}
                                    </td>
                                </tr>
