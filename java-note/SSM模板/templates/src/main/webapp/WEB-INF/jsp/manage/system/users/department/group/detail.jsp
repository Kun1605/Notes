...
<s:url value="/manage/system/users/group/edit" var="addURL"/>
<s:url value="/manage/system/users/group/edit?id=${groupInfo.id}" var="editURL"/>
<s:url value="/manage/system/users/group/delete?id=${groupInfo.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="groupInfo.departmentId"/></strong></td>
                                        <td>
                                            ${groupInfo.departmentId}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="groupInfo.groupName"/></strong></td>
                                        <td>
                                            ${groupInfo.groupName}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="groupInfo.groupMemo"/></strong></td>
                                        <td>
                                            ${groupInfo.groupMemo}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="groupInfo.status"/></strong></td>
                                        <td>
                                            ${groupInfo.status}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="groupInfo.createTime"/></strong></td>
                                        <td>
                                            ${groupInfo.createTime}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="groupInfo.id"/></strong></td>
                                    <td>
                                        ${groupInfo.id}
                                    </td>
                                </tr>
