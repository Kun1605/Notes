...
<s:url value="/manage/system/menu/delete?id=${showMenuInfo.id}" var="delURL"/>
<!DOCTYPE html>
                    ...
                    <div class="span12">
                        <fieldset class="adminform">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.parentId"/></strong></td>
                                        <td>
                                            ${showMenuInfo.parentId}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.code"/></strong></td>
                                        <td>
                                            ${showMenuInfo.code}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.value"/></strong></td>
                                        <td>
                                            ${showMenuInfo.value}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.orderNumber"/></strong></td>
                                        <td>
                                            ${showMenuInfo.orderNumber}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.pkgName"/></strong></td>
                                        <td>
                                            ${showMenuInfo.pkgName}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.path"/></strong></td>
                                        <td>
                                            ${showMenuInfo.path}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.enable"/></strong></td>
                                        <td>
                                            ${showMenuInfo.enable}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong><s:message code="menuInfo.discard"/></strong></td>
                                        <td>
                                            ${showMenuInfo.discard}
                                        </td>
                                    </tr>
                                <tr>
                                    <td><strong><s:message code="menuInfo.id"/></strong></td>
                                    <td>
                                        ${showMenuInfo.id}
                                    </td>
                                </tr>
