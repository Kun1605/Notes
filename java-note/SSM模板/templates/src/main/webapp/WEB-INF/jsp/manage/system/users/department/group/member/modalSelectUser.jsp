...
<div class="control-group">
    <div class="control-label">
        <label id="jform_userId-lbl" for="jform_userName" class="hasTooltip required"
               title="<sg:message code="TIP_TITLE" ref="groupUser.userId,groupUser.userId.tip"/>">
            <s:message code="groupUser.userId"/><span class="star">&#160;*</span></label>
    </div>
    <div class="controls">
        <div class="field-user-wrapper"
             data-url="<s:url value="/manage/system/users/department/group/member/selectUser?filter[groupId]=${groupUser.groupId}"/>"
             data-modal=".modal"
            ...
            <div class="input-append">
                <sg:message code="groupUser.userId.tip" var="userTip"/>
                ...
                <a class="btn btn-primary button-select" title="选择业务组成员">
